...
// Veritabanından Pilates dersinin detaylarını çekmek için sorgu
$sorgu_ders = mysqli_query($baglanti, "SELECT * FROM grup_dersleri WHERE ders_adi = 'Pilates'");
